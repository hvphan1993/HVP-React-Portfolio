      ...
      <VerticalTimeline lineColor="#4464AD">
        ...
        >
          <h3 className="vertical-timeline-element-title">
            UC Berkeley Virtual Software Engineering Boot Camp Certificate
            Program, CA
          </h3>
          <p>Completed 6-month bootcamp</p>
          <p>Earned certificate</p>
          <p>
            Completed projects solo and through collaboration with small groups
          </p>
        ...
        >
          ...
          <p>
            Country Lane/Castlemont Elementary, San Jose/Campbell, CA 2019-2020
          </p>
          ...
          <p>
            Utilize 64 lesson plans for 8 units designed to promote student
            learning and activity under the National and California Standards{" "}
          </p>
          <p>
            Collaborate with over 20 peer teachers to improve and design daily
            lessons and manage student behavior
          </p>
        </VerticalTimelineElement>
